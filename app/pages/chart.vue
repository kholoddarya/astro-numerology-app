<template>
  ...
  >
    <!-- Герой секция (строго как на странице нумерологии) -->
    <section
    ...
    >
      ...
      >
        <div class="text-center space-y-4">
          ...
          >
            Ваш персональный
            <span class="text-brass-400">астрологический</span> портрет
          </h1>

          <p
            class="text-starlight/60 font-body text-lg max-w-2xl mx-auto leading-relaxed"
          >
            Рассчитайте положение планет, Асцендент и число жизненного пути.
            Узнайте свой потенциал и кармические задачи.
          </p>
        </div>
      </div>
    </section>
    ...
    <div class="relative z-10">
      <!-- Основная сетка -->
      <div class="max-w-[1440px] mx-auto px-4 pb-16 space-y-8 py-16">
